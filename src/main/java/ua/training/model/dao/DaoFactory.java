    ...
    public static DaoFactory getInstance() {
        if (daoFactory == null) {
            try {
                ...
                properties.load(DaoFactory.class.getResourceAsStream(DB_PROPERTIES_FILE));
                daoFactory = (DaoFactory) Class.forName(properties.getProperty(FACTORY_CLASS)).newInstance();
