...
import static ua.training.util.AttributeConstants.EMAIL;
import static ua.training.util.RoleConstants.DISPATCHER;
import static ua.training.util.RoleConstants.TENANT;
import static ua.training.util.RouteConstants.APPLICATION_ROUTE;
import static ua.training.util.RouteConstants.BRIGADE_WITH_ID_ROUTE;
import static ua.training.util.RouteConstants.DELETE_APPLICATION_ROUTE;
import static ua.training.util.RouteConstants.HOME_ROUTE;
import static ua.training.util.RouteConstants.LOCALE_ROUTE;
import static ua.training.util.RouteConstants.LOGIN_ROUTE;
import static ua.training.util.RouteConstants.LOGOUT_ROUTE;
...
import static ua.training.util.RouteConstants.ROOT_ROUTE;
import static ua.training.util.RouteConstants.TASK_ROUTE;
import static ua.training.util.RouteConstants.USER_APPLICATIONS_ROUTE;
import static ua.training.util.RouteConstants.USER_ROUTE;
import static ua.training.util.RouteConstants.USER_WITH_ID_ROUTE;
